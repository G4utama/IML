...
\begin{center}
    ...
    \end{tabular}
\end{center}
We then estimate a good decision boundary by deciding the direction ($\theta$) and position ($\theta_0$) of the boundary, and we need a parameter selection criterion. For example, the loss functions as follows:
\begin{itemize}
